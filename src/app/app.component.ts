...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, CartComponent, CategoryBarComponent, FooterComponent, ItemsComponent, NavbarComponent, BannerComponent, BranchItemComponent, BackgroundLayerComponent, AddToCartItemModalComponent, MobilCategoryBarComponent, OrderOptionComponent],
