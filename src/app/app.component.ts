...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, CartComponent, CategoryBarComponent, FooterComponent, ItemsComponent, NavbarComponent, BannerComponent, PickupComponent, BackgroundLayerComponent, AddToCartItemModalComponent, MobilCategoryBarComponent, OrderOptionComponent,DeliveryComponent ,DriveComponent],
